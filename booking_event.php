...
<body>
    ...
    <div class="row mt-3">
        <div class="col">
          <div class="row justify-content-center">
            <div class="col-3 col-lg-auto">
              <img src="img/order/event/step1_alt.png" alt="">
            </div>
      ...
      <form action="booking_event2.php" method="POST">
      <div class="row mt-4">
        ...
        <div class="row my-4">
          <div class="col-lg-8 mx-auto p-4" style="border: 1px solid #000">
            <div class="row">
              ...
              <div class="col-9"><?=$event[0]['eventname']?></div>
            </div>
            <hr>
            <div class="row mt-4">
              <div class="col-3">發起人</div>
              <div class="col-9"><?=$event[0]['organizer']?></div>
            </div>
            <hr>
            <div class="row mt-4">
            ...
            <div class="row mt-4">
              ...
              <div class="col-9"><?=substr($event[0]['date'],0,16)?></div>
            </div>
            <hr>
            <div class="row mt-4">
            ...
            <div class="row mt-4">
              ...
              <div class="col-9">
                <div class="d-flex mb-3">
                  <div>需求人數</div>
                  <div class="ml-3"><?=$event[0]['num']?> 人</div>
                </div>
                <div class="d-flex mb-3">
                  <div>花費預算</div>
                  <div class="ml-3">$ <?=$event[0]['budget']?></div>
                </div>
                <div class="d-flex mb-3">
                  <div>活動時長</div>
                  <div class="ml-3"><?=$event[0]['timelength']?> h</div>
                </div>
                <div class="d-flex">
                  <div>活動類型</div>
                  <div class="ml-3"><?=$event[0]['type']?></div>
                </div>
              </div>
            </div>
            <hr>
            <div class="row mt-4">
              ...
              <div class="col-9"><?=$event[0]['memo']?></div>
