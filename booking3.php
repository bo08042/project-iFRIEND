...
<body>
    ...
    <?php
      ...
      $minfo=select("t3_member_info","acc='".$_SESSION['admin']."'");
      // print_r($info);
      // print_r($_POST);
    ?>
    <div class="container">
      <div class="row mt-3">
        <div class="col">
          <div class="row justify-content-center">
            ...
            <div class="col-3 col-lg-auto">
              <img src="img/order/member/step4_alt.png" alt="">
            </div>
          </div>
        </div>
      </div>
      <form action="booking_event3.php" method="POST">
        <div class="row mt-4">
          <div class="col col-lg-8 mx-auto">
            ...
            if($_GET['id']=="fail"){
            ?>
            <h4 align="center" class="mt-3">申請失敗！</h4>
            <?php
            }
            else{
            ?>
            <h4 align="center" class="mt-3">申請成功！</h4>
            <?php
            }
            ?>
          </div>
        ...
        <div class="col-lg-8 mx-auto p-4 d-flex flex-column justify-content-center align-items-center" style="height: 300px">
          <div class="h4">此訂單已登錄，請選擇其他訂單</div>
          <div>
            <a href="./search.php" class="btn btn-primary mt-5">回搜尋頁面</a>
          </div>
        </div>
        </div>
        <?php
          ...
          $oinfo=select('t7_member_order','id='.$_GET['id']);
          $info=select('t3_member_info','acc="'.$oinfo[0]['whoacc'].'"');
          $prof=select('t4_profile','acc="'.$oinfo[0]['whoacc'].'"');
        ?>
        <div class="col-lg-8 mx-auto p-4 d-flex justify-content-center align-items-center">
          <div class="h4">詳細訂單可於<a href="./member_page.php?do=mhistory" class="b-btn">會員專區頁面</a>查看</div>
        </div>
        <div class="col-lg-8 mx-auto p-4" style="border: 1px solid #000">
          <div class="row">
            ...
            <div class="row mt-4">
              ...
              <div class="col-9">
                <div class="d-flex mb-3">
                  <div>申請日期：</div>
                  <div class="ml-4"><?=$oinfo[0]['date']?></div>
                </div>
                <div class="d-flex mb-3">
                  <div>申請時數：</div>
                  <div class="ml-4"><?=$oinfo[0]['timelength']?></div>
                </div>
                <div class="d-flex mb-3">
                  <div>地點：</div>
                  <div class="ml-4"><?=$oinfo[0]['place']?></div>
                </div>
                <div class="d-flex">
                  <div>行程：</div>
                  <div class="ml-4"><?=$oinfo[0]['schedule']?></div>
                </div>
              </div>
            </div>
            <hr>
            <div class="row mt-4">
              ...
              <div class="col-9"><?=$oinfo[0]['memo']?></div>
            </div>
          </div>
        </div>
